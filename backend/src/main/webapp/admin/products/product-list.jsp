      ...
      <div class="filter-section">
        <form action="${pageContext.request.contextPath}/admin/products" method="get" class="filter-form">
          <div class="search-wrapper">
            ...
            <input type="text" name="search" placeholder="Tìm kiếm sản phẩm..." class="search-input" value="${param.search}">
          </div>
          <div class="filter-actions">
            <button type="submit" class="btn-apply-filter"><i class="fa-solid fa-filter"></i> Tìm kiếm</button>
          </div>
        </form>
      </div>
            ...
            <tr class="product-row">
              ...
              <td class="col-image">
                <div class="product-thumbnail">
                  ...
                  <img src="${p.imageUrl}" alt="${p.name}" onerror="this.src='https://via.placeholder.com/50'">
              ...
              <td class="col-actions">
                <div class="action-buttons">
                  <a href="${pageContext.request.contextPath}/admin/products?action=edit&id=${p.id}" class="btn-action btn-edit" title="Chỉnh sửa">
